...
\begin{figure}[H] 
	\centering 
	\animategraphics[autoplay, loop, poster =234, width = 0.5\textwidth]{15}{images/tricanter-movie/tricanter-movie-}{0}{384} 
...
\section{Conclusions}
Hem acabat concloent que el factor amb un efecte més significatiu en la concentració de fosfat en la mostra final és la interacció entre el diferencial, el cabal i el volum en C-O3. També hem vist que els efectes dels factors no són exactament com ens esperàvem, i que el de la velocitat de la bomba és un efecte negatiu segons l'estudi.
